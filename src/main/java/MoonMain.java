public class MoonMain {
    ...
    public static void main (String[] args){
        ...
        int month = 8;
        double day = 6;
        MoonCalculator test = new MoonCalculator(38, -78, false);
        //test.calcMoon(1, 1, 2015, 0);
        //MoonCalculator.MoonPhase w = test.moonPhase();
        //System.out.println("moon phase: " + w);

        MoonCalculator m = new MoonCalculator(currentLat, currentLong, true);

        for (int i = 0; i < 24; i++) {
            m.calcMoon(month, day, year, i);
            if (i == 0){
                MoonCalculator.MoonPhase phase = m.moonPhase();
        ...
        //MoonCalculator c = new MoonCalculator(11, 4, 2000, 3, currentLat, currentLong, false);

        //for (int i = 0; i < 24; i++){
            //System.out.println("time (UT): " + i);
            //MoonCalculator test = new MoonCalculator(8, 5, 2021, i, currentLat, currentLong, false);
        //}
    }
}
